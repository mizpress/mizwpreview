 ...
 *
 *      $logger = new \MailPoetVendor\Monolog\Logger('all', array(new \MailPoetVendor\Monolog\Handler\PHPConsoleHandler()));
 *      \MailPoetVendor\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('MailPoetVendor\Monolog\\'), // array Hide calls of classes started with...
    ...
    /**
     * @param  array          $options   See \MailPoetVendor\Monolog\Handler\PHPConsoleHandler::$options for more details
